    ...
    <div>
        <div v-if="!comparing">
            <div class="row">
                <div class="col">
                    <div class="form-group btn-group-justified form-inline">
                        <input type="text" v-model="search" class="form-control col-10"
            ...
            <div class="row" v-if="filtered_mobiles.length">
                <div class="col-3" v-for="(mobile,index) in filtered_mobiles">
                    ...
                    <div class="card">
                        <img class="card-img-top image" :src="mobile.image" width="100">
                        <div class="middle">
        ...
        <div v-if="comparing">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="text-align: center; " v-for="(selected_mobile_data, index) in selected_mobiles_data">
                        <img :src="selected_mobile_data.image" style="max-width: 166px;width: 80%;display: block">
                    </td>
                </tr>
                <tr>
                    <td style="width: 180px">Name</td>
                    <td v-for="(selected_mobile_data, index) in selected_mobiles_data">{{selected_mobile_data.name}}
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td v-for="(selected_mobile_data, index) in selected_mobiles_data">
                        <p v-for="external_storage in selected_mobile_data.external_storage">{{external_storage}} GB</p>
                    </td>
                </tr>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td v-for="(selected_mobile_data, index) in selected_mobiles_data">
                        <i class="fa fa-check text-success" v-if="selected_mobile_data.battery_is_removable"></i>
                        <i class="fa fa-times text-danger" v-if="!selected_mobile_data.battery_is_removable"></i>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td v-for="(selected_mobile_data, index) in selected_mobiles_data">
                        <i class="fa fa-check text-success" v-if="selected_mobile_data.communication_hotspot"></i>
                        <i class="fa fa-times text-danger" v-if="!selected_mobile_data.communication_hotspot"></i>
                    </td>
                </tr>
