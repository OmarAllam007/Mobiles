...
<div class="form-group {{$errors->has('communication_hotspot')? 'has-error' : ''}}">
    <label for="communication_hotspot">{{t('Hotspot')}}
        <input type="checkbox"  name="communication_hotspot" id="communication_hotspot" value="{{$mobile->communication_hotspot ?? ''}}">
    </label>
...
<div class="form-group {{$errors->has('communication_nfc')? 'has-error' : ''}}">
    <label for="communication_nfc">{{t('NFC')}}
        <input type="checkbox"  name="communication_nfc" id="communication_nfc" value="{{$mobile->communication_nfc ?? ''}}">
    </label>
...
<div class="form-group {{$errors->has('communication_otg')? 'has-error' : ''}}">
    <label for="communication_otg">{{t('OTG')}}
        <input type="checkbox"  name="communication_otg" id="communication_otg" value="{{$mobile->communication_otg ?? ''}}">
    </label>
...
<div class="form-group {{$errors->has('communication_ir')? 'has-error' : ''}}">
    <label for="communication_ir">{{t('IR')}}
        <input type="checkbox"  name="communication_ir" id="communication_ir" value="{{$mobile->communication_ir ?? ''}}">
    </label>
