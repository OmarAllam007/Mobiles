...
<div class="form-group {{$errors->has('media_speaker')? 'has-error' : ''}}">
    ...
    <input type="text" class=" form-control-sm form-control" name="media_speaker" id="media_speaker" >
...
<div class="form-group {{$errors->has('media_radio_exist')? 'has-error' : ''}}">
    <input type="checkbox"  name="media_radio_exist" id="media_radio_exist" @if(isset($mobile) && $mobile->media_radio_exist) checked @endif>
...
<div class="form-group {{$errors->has('media_is_35_mm_slot')? 'has-error' : ''}}">
    <input type="checkbox"  name="media_is_35_mm_slot" id="media_is_35_mm_slot" @if(isset($mobile) && $mobile->media_is_35_mm_slot) checked @endif>
