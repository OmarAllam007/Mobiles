...
<div class="form-group {{$errors->has('battery_type')? 'has-error' : ''}}">
    ...
    <input type="text" class=" form-control-sm form-control" name="battery_type" id="battery_type"
           value="{{$mobile->battery_type ?? ''}}">
...
<div class="form-group {{$errors->has('battery_calls_until')? 'has-error' : ''}}">
    ...
    <input type="text" class=" form-control-sm form-control" name="battery_calls_until" id="battery_calls_until"
           value="{{$mobile->battery_calls_until ?? ''}}">
...
<div class="form-group {{$errors->has('battery_music_until')? 'has-error' : ''}}">
    ...
    <input type="text" class=" form-control-sm form-control" name="battery_music_until" id="battery_music_until"
           value="{{$mobile->battery_music_until ?? ''}}">
...
<div class="form-group {{$errors->has('battery_video_until')? 'has-error' : ''}}">
    ...
    <input type="text" class=" form-control-sm form-control" name="battery_video_until" id="battery_video_until"
           value="{{$mobile->battery_video_until ?? ''}}">
