...
tinymce.init({
    selector: '.richeditor',
    plugins: [
        'image advlist autolink lists link imagetools charmap print preview anchor',
        'insertdatetime media table paste directionality textcolor colorpicker paste'
    ],
    toolbar: 'paste | undo redo | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent table | link | fontselect fontsizeselect | rtl | forecolor| image', // image
    menubar: true,
